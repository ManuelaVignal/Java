...
function getBookmarks() {  //funzione carica il file jsonArray di /bookmarks
   let path = "http://localhost:8080/bkmapp/resources/bookmarks";
    fetch(path)
            .then(ris =>
                ris.json())
            .then(jsobj => {
...
function init() {
    ...
    function logout() {
        ...
        window.location.href = "/bkmapp-front/index.html";
    }

    function login() {
        let url = "http://localhost:8080/bkmapp/resources/authors/login"; //path delle risorse 
...
function postBookmarks() {
        let url = "http://localhost:8080/bkmapp/resources/bookmarks"; //path delle risorse 
    ...
    function deleteBookmarks(){
        ...
        let url = "http://localhost:8080/bkmapp/resources/bookmarks/" + txtnumbook.value;
