...
app.controller('loginCtrl',
        function ($scope, $http) {
            ...
            $scope.login = function () {
                ...
                let req = {
                    url: "http://localhost:8080/bkmapp/resources/authors/login",
                    method: "POST",
            ...
            $scope.getMyBkms = function () {
                let  myurl = "http://localhost:8080/bkmapp/resources/bookmarks/" + sessionStorage.getItem("myid");
                let req = {
                    url: myurl,
                    method: "GET",
                    headers: {
            ...
            $scope.creaBkm = function () {
                let  myurl = "http://localhost:8080/bkmapp/resources/bookmarks/";
                let sh = false;
                if ($scope.sh === "true")
                    sh = true;
            ...
            $scope.logout = function () {
                ...
                window.location.href = "/bkmapp-front/es_angularjs.html";
            };

            $scope.EliminaBK = function () {
                let  myurl = "http://localhost:8080/bkmapp/resources/bookmarks/"+ $scope.iddelete;
                console.log(myurl);
